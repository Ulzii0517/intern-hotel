  ...
  return (
    <div className="flex flex-col gap-4 lg:w-[672px]  sm:w-[200px] md:w-[300px] space-y-3  ">
      ...
      <div className="flex gap-4 ">
        <Button
          className="flex w-full justify-start py-7 px-8 items-center gap-4"
          variant="outline"
        >
          <MailIcon />
          <div className="flex flex-col items-start">
            <p className="text-sm font-semibold leading-5">Email</p>
            <p className="text-sm font-normal leading-5 text-[#71717A] ">
              n.shagai@pinecone.mn
            </p>
          </div>
        </Button>

        <Button
          className="flex w-full justify-between py-7 px-8 items-center gap-4"
          variant="outline"
        >
          <div className="flex gap-4">
            <KeyIcon />
